<template>
    <div class="supervisionGame t_left">
        ...
        <el-table :data="TableData.value" border size="mini" :header-cell-style="{background:'#DCDFE6',color:'#000'}" style="width: 100%" :key="formData.gameType" v-if="formData.gameType == 'BaijialeSuper6'">
            ...
            <el-table-column label="操作" align="center" width="160" fixed="right">
                <template slot-scope="scope">
                    <el-button type="primary" size="mini">详 情</el-button>
...
export default {
    data(){
        return{
            ...
            TableData:{
                title:[{id:"id",name:"ID"},{id:"deskNumber",name:"台面编号"},{id:"gameType",name:"游戏类型"},{id:"number",name:"游戏局号"},{id:"staffNumber",name:"操作员账号"},{id:"operationIp",name:"现场操作IP"},{id:"orderNums",name:"订单数量"},{id:"betMoney",name:"投注金额"},{id:"drawMoney",name:"系统输赢"},{id:"drawResult",name:"开奖结果"},{id:"deskStartDate",name:"开台日期"},{id:"createdAt",name:"创建时间"}],
                value:[]
            },
            pickerOptions: {        
                shortcuts: [{
    ...
    methods:{
        ...
        searchCli(){
            ...
            this.$http.post(this.$Api.supervisionGameGetListApi,params).then(
                (res)=>{
                    ...
                    console.log("局口列表",res.data.data)
                },
                (error)=>{
                    this.showSearchBtn = true;
                    console.log(error)
