    ...
    <div class="credit">
        ...
        <div class="topBox f_0">
            ...
            <div class="rightBox v_top">
                ...
                <p class="t_center" v-if="dialogList.status.id == '0'">
                    <el-button type="primary" size="small" @click="submit(1)" v-if="dialogList.status.id == '0' || dialogList.status.id == '3'">提交</el-button>
                    <el-button type="primary" size="small" @click="submit(1)" v-if="dialogList.status.id == '0' || dialogList.status.id == '3'">删除</el-button>
                </p>
                ...
                <p class="t_center" v-if="dialogList.status.id == '1'"><el-button class="bg_green" size="small" @click="submit(2)">审核通过</el-button><el-button class="bg_red" size="small" @click="submit(3)">审核不通过</el-button></p>
                <p class="t_center" v-if="dialogList.status.id == '0'"><el-button type="primary" size="small" @click="submit(1)">受理</el-button></p> -->
            </div>
        </div>
        <!-- 底部台面剩余 -->
        <div class="bottomBox">
